...
@section('chefd')
 ...
 @extends('maitrest.maitrest_master')
 @section('maitrest')
 ...
 <div x-show="loaded" x-init="window.addEventListener('DOMContentLoaded', () => {setTimeout(() => loaded = false, 500)})" class="f q r ze rd nj pa">
  ...
  >
    ...
    <ul class="lc hg bh">
        ...
        <li>
          <a
            class="nr h un lc mg sg qh gp dp nl rl _q qq"
            href="{{route('demande.indexMaitrestage')}}"
  ...
  >
    ...
    >
      <a class="lc mg zg" href="{{route('maitrest.dashboard')}}">
        <img
          class="vr"
          ...
          >
            <span class="pc tu in">
              <span
                ...
                >{{Auth::guard('maitrestage')->user()->name}}</span
              >
              <span class="jc nn">{{Auth::guard('maitrestage')->user()->email}}</span>
            </span>
