        ...
        <div class="sk bu 2xl:ud-p-11">
          ...
          >
            ...
            >
              ...
              <form action="{{route('etidiant.edit')}}" method="POST">
                @csrf
                ...
                <div class="db">
                  ...
                  <input
                    ...
                    value="{{Auth::guard('etidiant')->user()->name}}"
                  />
                </div>
                ...
                <div class="db">
                  ...
                  <input
                    ...
                    value="{{Auth::guard('etidiant')->user()->email}}"
                  />
                </div>
            ...
            >
              ...
              <form action="{{route('etidiant.editp')}}" method="POST">
                @csrf
