{{-- @extends('etidiant.etidiant_master')
@section('etidiant')
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
     ...
     <div class="d-flex align-items-center justify-content-between">
       <a href="{{route('etidiant.dashboard')}}" class="logo d-flex align-items-center">
         <img src="assets/img/logo.png" alt="">
         <span class="d-none d-lg-block">Niceetidiant</span>
       </a>
       ...
       <ul class="d-flex align-items-center">
         ...
         <li class="nav-item dropdown pe-3">
           ...
           <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
             ...
             <span class="d-none d-md-block drop down-toggle ps-2">{{Auth::guard('etidiant')->user()->name}}</span>
           </a><!-- End Profile Iamge Icon -->

           <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
             <li class="dropdown-header">
               <h6>{{Auth::guard('etidiant')->user()->name}}</h6>
               <span>{{Auth::guard('etidiant')->user()->email}}</span>
             </li>
             <li>
               <hr class="dropdown-divider">
             </li>
             ...
             <li>
               <a class="dropdown-item d-flex align-items-center" href="{{route('etidiant.logout')}}">
  ...
  @endif
       <li class="nav-item">
         <a class="nav-link " href="{{route('etidiant.dashboard')}}">
   ...
   <footer id="footer" class="footer">
     <div class="copyright">
       &copy; Copyright <strong><span>Niceetidiant</span></strong>. All Rights Reserved
     </div>
     <div class="credits">
       <!-- All the links in the footer should remain intact. -->
       <!-- You can delete the links only if you purchased the pro version. -->
       <!-- Licensing information: https://bootstrapmade.com/license/ -->
       <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/nice-etidiant-bootstrap-etidiant-html-template/ -->
...
@endsection
 ...
 <div x-show="loaded" x-init="window.addEventListener('DOMContentLoaded', () => {setTimeout(() => loaded = false, 500)})" class="f q r ze rd nj pa">
  ...
  >
    ...
    >
      <a class="lc mg zg" href="{{route('etidiant.dashboard')}}">
        <img
          class="vr"
          ...
          >
            <span class="pc tu in">
              <span
                ...
                >{{Auth::guard('etidiant')->user()->name}}</span
              >
              <span class="jc nn">{{Auth::guard('etidiant')->user()->id}}</span>
            </span>
