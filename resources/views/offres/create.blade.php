...
<form action="{{route('offres.store')}} " method="POST">
    ...
    <div class="mb-3">
      ...
      <input name="datedebut" type="" class="form-control" id="datedebut" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
        <label for="dure" class="form-label">  dure'</label>
        <input name="dure" type="" class="form-control" id="dure" aria-describedby="emailHelp">
      </div>
        <label for="maitrestage_id" class="form-label">maitrestage_id</label>
        <select name="maitrestage_id" class="form-control">
            @foreach($maitrestage as $m)
                <option value="{{ $m->id }}">{{ $m->name }}</option>
            @endforeach
        </select>
      <div class="mb-3">
        <label for="nmbrpostes" class="form-label"> nmbrpostes</label>
        <input name="nmbrpostes" type="text" class="form-control" id="nmbrpostes" aria-describedby="emailHelp">
      </div>
      <div class="mb-3">
        <label for="poste" class="form-label"> poste</label>
        <input name="poste" type="text" class="form-control" id="poste" aria-describedby="emailHelp">
      </div>
