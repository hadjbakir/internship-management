              ...
              {{-- <table class="yd yf rh">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="col-sm">
                        <a href="{{ route('demande.createfromoffres', $item->maitrestages_id) }}"
                            class="btn btn-primary">Create Demande</a>
                    </td>
                    <td class="_l tm nm in">



                <form action="{{route('offres.destroy', $item ->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
                      <button
                        type="submit"
  ...
  <body>
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <!-- Your menu code here -->
          <!-- Make sure the menu column takes up appropriate width -->
        </div>
        <div class="col-md-9">
          <div class="row">
            @foreach ($offres as $item)
            <div class="col-md-4">
              <div class="card">
                ...
                <div class="card-links">
                  ...
                  <a href="{{ route('demande.createfromoffres', $item->maitrestages_id) }}" class="btn btn-success">Join</a>
                </div>
              </div>
            </div>
            @endforeach
...
<table class="table">
    ...
    <tr>
        <th scope="col">id</th>
        <th scope="col">stage maitrestage_id</th>
        <th scope="col">datedebut id</th>
        <th scope="col">dure</th>
        <th scope="col">nmbrpostes</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$item->dure}}</td>
            <td>{{$item->nmbrpostes}}</td>
            <td>{{$item->poste}}</td>
            <div class="container">
                <div class="row">
                  <div class="col-sm">
                    <td><a href="{{route('offres.edit', $item ->id)}}"  class="btn btn-success">edit</a></td>
                </div>
                  <div class="col-sm">
                    <td><a href="{{route('offres.show', $item ->id)}}" class="btn btn-primary">show</a></td>
                </div>
                  <div class="col-sm">
                    <td>
                        <form action="{{route('offres.destroy', $item ->id)}}" method="POST">
