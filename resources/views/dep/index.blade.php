          ...
          <form action="{{route('dep.store')}} " method="POST">
            ...
            <div class="db">
              <label
                ...
                >faculty id:</label
              >
              <select name="faculty_id" class="kkk nj qh ni bj jr fr ps zn gs il cm zr wr">
      ...
      <table class="yd yf rh">
        ...
        <tbody>
          ...
          >
            ...
            <td class="_l rl">
              <h5 class="un">{{$f->faculty_id}}</h5>

            </td>
            <td class="_l rl">
                <h5 class="un">{{$f->name}}</h5>

              </td>

            <td class="_l rl">
                <a class="btn btn-primary" href="{{ route('dep.edit',$f->id) }}">Edit</a>
            ...
            <td class="_l rl">
                ...
                <a class="btn btn-info" href="{{ route('dep.show',$f->id) }}">Show</a>
            ...
            <form action="{{ route('dep.destroy',$f->id) }}" method="POST">
            @csrf
            @method('DELETE')
