...
@section('admin')
 ...
 <div x-show="loaded" x-init="window.addEventListener('DOMContentLoaded', () => {setTimeout(() => loaded = false, 500)})" class="f q r ze rd nj pa">
  ...
  >
    ...
    >
      <a class="lc mg zg" href="{{route('admin.dashboard')}}">
        <img
          class="vr"
          src="{{asset('part/src/images/logo/logo-light.svg')}}"
          alt="Logo"
        />
        <img
          class="pc ur"
          src="{{asset('part/src/images/logo/logo-dark.svg')}}"
          alt="Logo"
        />
        ...
        <ul class="lc mg vg">
          <li>
            ...
            <label class="jc ua h">
              ...
              <img
                class="vr"
                src="{{asset('part/src/images/icon/icon-sun.svg')}}"
                alt="Sun"
              />
              <img
                class="pc ur"
                src="{{asset('part/src/images/icon/icon-moon.svg')}}"
                alt="Moon"
              />
            </label>
            <!-- Dark Mode Toggler -->
            ...
            <ul class="lc hg tg ph ip pd rl ym fn">
              <li class="nr cg h lc mg qg vg qh sq js yk">
                <a class="lc mg ug" href="#">
                  <div class="wf">
                    <img src="{{asset('part/src/images/user/user-03.png')}}" alt="User" />
                  </div>
              ...
              <li class="nr cg h lc mg qg vg qh sq js yk">
                <a class="lc mg ug" href="#">
                  <div class="wf">
                    <img src="{{asset('part/src/images/user/user-02.png')}}" alt="User" />
                  </div>
        ...
        <div class="h" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
          ...
          >
            <span class="pc tu in">
              ...
              >
              <span class="jc nn">{{Auth::guard('admin')->user()->email}}</span>
            </span>

            <span class="th ni vj bj wr uk">
              <img src="{{asset('part/src/images/user/user-01.png')}}" alt="User" />
            </span>
