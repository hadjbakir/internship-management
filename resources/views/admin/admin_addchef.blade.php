          ...
          >
            ...
            >
              ...
              >
                ...
                <form action="{{ route('admin.addchefdep')}}" method="POST">
                    @csrf
                <div class="db">
                  <label
                ...
                <div class="db">
                  ...
                  <div class="db">
                    ...
                    <select name="sexe" class="kkk nj qh ni bj jr fr ps zn gs il cm zr wr">
                        ...
                        <option value="saab">Guy</option>
                        <option value="saab">faget</option>
                        <option value="saab">Transgender</option>
                  ...
                  <div class="db">
                    <label
                      ...
                      >Departement</label
                    >
                    <select name="dep_id" class="kkk nj qh ni bj jr fr ps zn gs il cm zr wr">
                        @foreach($deps as $dep)
          ...
          <table class="yd yf rh">
            ...
            <tbody>
              ...
              >
                ...
                <td class="_l rl">
                    <h5 class="un">{{ $item->stauts }}</h5>
                </td>
                <td class="_l rl">
                    <a href="{{route('admin.beforeupdate', $item ->id)}}"
