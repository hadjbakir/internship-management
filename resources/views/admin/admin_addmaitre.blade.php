  ...
  @endif
        <div class="sk bu 2xl:ud-p-11">
          ...
          >
            ...
            <form action="{{route('admin.addentreprise')}} " method="POST">
              @csrf
            ...
            >
              ...
              MAITRESTAGE
                ...
                <form action="{{ route('admin.addmaitre')}}" method="POST">
                    @csrf
                ...
                <div class="db">
                  ...
                  <div class="db">
                    ...
                    <select name="entrp_id" class="kkk nj qh ni bj jr fr ps zn gs il cm zr wr">
                        ...
                        <option value="{{ $entreprise->id }}">{{ $entreprise->nomentrp }}</option>
                    @endforeach
                    </select>
                  </div>
          ...
          <table class="yd yf rh">
            ...
            <tbody>
              ...
              >
                ...
                <td class="_l rl">
                    <h5 class="un">{{ $item->family }}</h5>

                </td>
                <td class="_l rl">
                    <h5 class="un">{{ $item->email }}</h5>

                </td>
                <td class="_l rl">
                    <a href="{{route('admin.beforeupdatem', $item ->id)}}"
                        class="btn btn-success">edit</a>
                </td>
                <td class="_l tm nm in">


                <form action="{{route('admin.destroymaitre', $item ->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
          ...
          <table class="yd yf rh">
            ...
            <tbody>
              ...
              >
                ...
                <td class="_l rm sm">
                  <h5 class="un">{{ $item->nomentrp }}</h5>

                </td>

                <td class="_l rl">
                  <h5 class="un">{{ $item->directeur }}</h5>

                </td>

                <td class="_l rl">
                    <h5 class="un">{{ $item->specialite }}</h5>

                </td>
                <td class="_l rl">
                    <h5 class="un">{{ $item->Adressentrp }}</h5>

                </td>
                <td class="_l rl">
                    <a href="{{route('admin.beforeupdatentrp', $item ->id)}}"
                        class="btn btn-success">edit</a>
                </td>
                <td class="_l tm nm in">


                <form action="{{route('admin.destroyentrp', $item ->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
