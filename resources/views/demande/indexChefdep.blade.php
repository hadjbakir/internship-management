                ...
                <tr>
                    ...
                    <td>@if ($item->depacp == 'notyet')
                      ...
                      >
                        ...
                        @endif</td>
                    <td>{{ $item->etidiants_id }}</td>
                    <td>{{ $item->maitrestage_id }}</td>
                    <td>{{ $item->dateinsc }}</td>
                    <td>{{ $item->datefin }}</td>
                    <td>{{ $item->period }}</td>
                    <td>{{ $item->theme }}</td>
                    <td> <a href="{{route('demande.editchefd', $item ->id)}}"
...
<div class="container mt-5">
    ...
    <tbody>
        @foreach ($nodemande as $item)
        <tr>

            <td>@if ($item->depacp == 'refuse')
                <p
              ...
              <table class="yd yf rh">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="_l rl">
                        <h5 class="un">{{ $item->etidiant_id }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->maitrestage_id }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->dateinsc }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->diplome }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->dure }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->period }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->theme }}</h5>
                    </td>
                    <td class="_l rl">
                        <h5 class="un">{{ $item->motif }}</h5>
                    </td>
                    <td class="_l rl">
                        <a href="{{route('demande.editchefd', $item ->id)}}"
